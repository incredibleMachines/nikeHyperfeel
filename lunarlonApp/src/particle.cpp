...
//------------------------------------------------------------
void particle::setInitialCondition(float px, float py, float vx, float vy, float _damping){
    damping = _damping; // copy to global variable
    pos.set(px,py);
	vel.set(vx,vy);
...
void particle::changeColor(ofVec2f _pos, float _radius){
